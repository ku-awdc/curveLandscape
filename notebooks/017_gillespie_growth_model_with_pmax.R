...
repeat {
  ...
  # death <- death_baseline * pmax(0, (1 - current_u / k0))
  # birth <- birth_baseline * abs(1 - current_u / k0)
  # death <- death_baseline * abs(1 - current_u / k0)
  # birth <- birth_baseline * pmax(0, (1 - current_u / k0))
  # death <- death_baseline * abs(1 - current_u / k0)
  birth <- pmax(0, (growth_baseline - (growth_baseline * current_u) / k0))
  death <- (growth_baseline / k0) * pmax(0, current_u - k0)
...
#' Cache the result
fs::dir_create(".cache")
results %>% write_rds(".cache/017_results_with_info.RDS")
