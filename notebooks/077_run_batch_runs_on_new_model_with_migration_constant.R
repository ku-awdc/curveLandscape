...
pdf("figures/077_plot_new_model_smooth_with_migration_constant.pdf")
for (id_m0 in seq_along(all_migration_baseline)) {
  ...
  for (id_landscape in seq_along(all_landscapes_trans)) {
    ...
    # Initialise at ideal equilibrium
  ...
  write_rds(all_landscapes, glue(
    ".cache/077_new_model_all_landscapes_default_m0_constant.rds"
  ))
  # fs::dir_create("figures")
  ggsave(
    p_plot_all_landscapes_together,
    filename = "figures/077_new_model_all_landscapes_default_m0_constant.svg",
