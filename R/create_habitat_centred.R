...
create_habitat_centred <- function(subpatch_cellsize) {
  subpatch_cellsize <- subpatch_cellsize * 1000
  # library("hexscape")
  # library("sf")
  # library("units")
  # library("pbapply")
  ...
  load_corine("DK032", verbose = FALSE) |>
  ...
  points |>
    ...
    pblapply(function(x) {
      ...
      split <- ceiling(area / subpatch_cellsize^2) |> as.numeric()
